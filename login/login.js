...
async function fetchUser() {
    const response = await fetch('https://http://[240e:399:f9e:5e30:17:3321:26ff:32a1]:3000//users')
...
loginBtn.addEventListener('click', async () => {
    const body = getBody()
    const response = await fetchData('https://http://[240e:399:f9e:5e30:17:3321:26ff:32a1]:3000//login', body)
    const data = await response.json()
...
registryBtn.addEventListener('click', async () => {
    const body = getBody()
    const response = await fetchData('https://http://[240e:399:f9e:5e30:17:3321:26ff:32a1]:3000//registry', body)
    const data = await response.json()
})